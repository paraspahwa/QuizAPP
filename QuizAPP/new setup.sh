#!/bin/bash
# ================================================================
# MedQuizAI — Budget-Optimized Repo Setup Script
# Designed to run on a single cheap VPS ($0–6/month)
# No Terraform, No EKS, No multi-instance AWS
#
...
echo ""
echo "================================================"
echo "  MedQuizAI — Budget Setup (Single VPS)"
echo "================================================"
echo ""
...
# Optional: Set to your domain for CORS (leave as-is for local dev)
...
# ── Step 5: Production docker-compose with Caddy (free HTTPS) ────
info "Writing production docker-compose..."
...
# ── Step 6: Caddyfile (auto HTTPS) ───────────────────────────────
info "Writing Caddyfile..."
cat > deploy/Caddyfile << 'EOF'
# ─── REPLACE yourdomain.com WITH YOUR ACTUAL DOMAIN ───
# Caddy auto-provisions free Let's Encrypt SSL certificates
...
# ─── For local/IP-only usage (no domain), use this instead: ───
...
# ── Step 7: VPS first-time setup script ──────────────────────────
info "Writing VPS setup script..."
cat > deploy/vps-setup.sh << 'SCRIPT'
#!/bin/bash
# ================================================================
...
log "VPS setup script written"

# ── Step 8: Backend files ─────────────────────────────────────────
...
# ── COST SAVING: gpt-4o-mini instead of gpt-4o ──
...
# ── Step 10: Simplified GitHub Actions (SSH to single VPS) ────────
...
echo "================================================"
echo ""
echo "What changed from the original:"
echo "  ✗ Removed: Terraform, EKS, multi-EC2, NAT Gateway (~\$212/mo)"
echo "  ✓ Added:   Single VPS + Docker Compose + Caddy (~\$0-6/mo)"
echo "  ✓ Changed: gpt-4o → gpt-4o-mini (~15x cheaper API calls)"
echo "  ✓ Added:   Quiz caching (avoid repeat OpenAI calls)"
echo ""
echo "Next steps:"
echo "  1. git add ."
echo "  2. git commit -m 'feat: budget-optimized deployment'"
echo "  3. git push origin main"
echo ""
echo "For VPS deployment, add these GitHub Secrets:"
echo "  VPS_HOST      your server public IP"
echo "  VPS_USER      appuser (or ubuntu)"
